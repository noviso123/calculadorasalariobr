      ...
      <div className="flex items-center justify-between mb-4">
        ...
        {!hasFetched && !loading && (
          <button
            ...
            className="px-4 py-2 bg-blue-700 text-white text-xs font-bold uppercase tracking-wider rounded-lg hover:bg-blue-800 transition-colors shadow-lg shadow-blue-200"
          >
            Gerar Conselhos
          </button>
        )}
